$(function () {
    var cartContent = location.search;
    var newstr = cartContent.slice(1);
    var arr = newstr.split("&");
    res = arr.map(function (item) {
        var newitem = item.split("=");
        return newitem[1];
    })
    var quantity = res[0]; //获取购物车信息（数量和id）
    var id = res[1];
    ...
    function render(str) {
        ...
        var res = str.data.map(function (item) {
            ...
            return `
                <ul class="order_lists" data-id="${item.id}">
                    ...
                    <li class="list_con">
                        <div class="list_img">
                            <a href="javascript:;"><img src="../img/index/${item.src}" alt=""></a>
                        </div>
                        <div class="list_text">
                    ...
                    <li class="list_amount">
                        <div class="amount_box">
                            ...
                            <input type="text" value="${quantity}" class="sum">
